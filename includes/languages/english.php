...
define('PULL_DOWN_DEFAULT', 'Categories');
...
define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br />Powered by <a href="http://www.oscommerce.com" target="_blank">osCommerce</a> and <a href="http://www.phpgenie.co.uk/" target="_blank">PHP Genie Ltd</a>');
?>
