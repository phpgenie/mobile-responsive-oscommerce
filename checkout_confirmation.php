...
?>
          <tr>
            <td><?php echo '<br><strong>' . HEADING_SHIPPING_METHOD . '</strong> <a href="' . tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
          </tr>
          <tr>
...
?>
          ...
          <tr>
            <td colspan="3"><?php echo '<br><strong>' . HEADING_PRODUCTS . '</strong> <a href="' . tep_href_link(FILENAME_SHOPPING_CART) . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
          </tr>
...
?>
 ...
 <br><h2><?php echo HEADING_BILLING_INFORMATION; ?></h2>
       ...
       <table border="0" width="100%" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td><?php echo '<br><strong>' . HEADING_PAYMENT_METHOD . '</strong> <a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '"><span class="orderEdit">(' . TEXT_EDIT . ')</span></a>'; ?></td>
          </tr>
          <tr>
